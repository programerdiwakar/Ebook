...
const Cart = () => {
  ...
  return (
    <div className='bg-zinc-900 px-12 md:h-screen py-8'>
      {!Cart && <div className='flex justify-center items-center h-screen'>
        <Loader />
      </div>}
      {Cart && Cart.length === 0 && (
        ...
        <>
          ...
          {Cart.map((items, i) => (
            <div className='w-full my-4 rounded flex flex-col md:flex-row p-4 bg-zinc-800 justify-between items-center' key={i}>
              <img src={items.url}
                alt='/'
                className='h-[20h] md:h-[10vh] object-cover'
              />
              <div className='w-full md:w-auto '>
                ...
                <p className='text-normal text-zinc-300 mt-2 hidden lg:block'>
                  {items.desc.slice(0,100)}_ _ _
                </p>
                <p className='text-normal text-zinc-300 mt-2 hidden md:block lg:hidden'>
                  {items.desc.slice(0,65)}_ _ _
                </p>
