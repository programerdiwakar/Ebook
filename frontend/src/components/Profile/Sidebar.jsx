...
const Sidebar = (data) => {
  ...
  return (
    <div className='text-white bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-[100%]'>
      ...
      <button
        className='bg-zinc-900 w-4/6 lg:w-full mt-4 lg:mt-0 text-white font-semibold flex items-center  justify-center p-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300'
        onClick={() => {
